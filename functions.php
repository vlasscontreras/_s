 ...
 */
require get_template_directory() . '/inc/customizer/class-_s-customizer.php';

/**
 * Load Jetpack compatibility file.
 */
if ( defined( 'JETPACK__VERSION' ) ) {
	require get_template_directory() . '/inc/jetpack/class-_s-jetpack.php';
}
...
if ( class_exists( 'WooCommerce' ) ) {
	require get_template_directory() . '/inc/woocommerce/class-_s-woocommerce.php';
}
